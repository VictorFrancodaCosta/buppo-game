...
export async function initiateMatchmaking() {
    ...
    try {
        ...
        const myData = { uid: window.currentUser.uid, name: window.currentUser.displayName, deck: window.currentDeck, timestamp: Date.now(), matchId: null, cancelled: false, status: 'waiting' };
