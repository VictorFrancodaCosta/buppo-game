...
@keyframes introBounce {
    /* 0% tem opacity 0 !important para garantir que comece invisível */
    0% { transform: translateY(120vh) scale(0.5); opacity: 0 !important; } 
    60% { transform: translateY(-40px) scale(1.1); opacity: 1 !important; }
    80% { transform: translateY(10px) scale(0.95); }
    100% { transform: translateY(0) scale(1); opacity: 1 !important; }
}
...
.intro-anim {
    ...
    pointer-events: none;
    /* SEM OPACITY 0 AQUI NO ROOT DA CLASSE PARA EVITAR CONFLITO */
}
