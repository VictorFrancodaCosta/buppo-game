...
safeLobbyEnhancement('ajustes visuais estaticos', () => {
    ...
    if (lobbyScreen) {
        ...
        const lobbyCardBorderItems = [
            ...
            { id: 'mage_fire_border', name: 'BORDA - CHAMA ARCANA', asset: 'assets/img/borda_chama_arcana_card.png?v=2026.06.23.18' },
            { id: 'elven_forest_border', name: 'BORDA - SENTINELA VERDE', asset: 'assets/img/borda_bosque_elfico_card.png?v=2026.06.23.18' },
            { id: 'rogue_gold_border', name: 'BORDA - M\u00c3O DOURADA', asset: 'assets/img/borda_mao_dourada_card.png?v=2026.06.23.18' },
            { id: 'oracle_border', name: 'BORDA - VIS\u00c3O ASTRAL', asset: 'assets/img/borda_visao_astral_card.png?v=2026.06.23.18' }
        ];
