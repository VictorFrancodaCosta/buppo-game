...
safeLobbyEnhancement('ajustes visuais estaticos', () => {
    ...
    if (lobbyScreen) {
        ...
        const lobbyClusterItems = [
            { id: 'cluster_knight', type: 'cluster', name: 'CLUSTER - GUARDA REAL', displayName: 'GUARDA REAL', asset: 'assets/img/cluster_testeclusternovo_cavaleiro.webp', shopAsset: 'assets/img/cluster_testeclusternovo_cavaleiro.webp' },
